...
VFILES:=theories/advancedRewrite.v
...
ML4FILES:=src/advanced_rewrite.ml4
...
install-natdynlink:
	install -d "$(DSTROOT)"$(COQLIBINSTALL)/AdvancedRewrite; \
