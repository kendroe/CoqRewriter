...
val getFunctionType: env -> int -> Type.etype ;;
...
val getTypeDefinition: env -> int -> (Type.etype * Type.typeDef) ;;
val isFiniteType: env -> int -> bool ;;
val getVarType: env -> int -> Type.etype ;;
...
val getType: env -> int -> Type.etype ;;
 ...
 * Misc.
 *)
val name_away_bound_vars: Exp.exp -> (int list) -> (Subst.unifier * Exp.exp) ;;
 ...
 *)
val addDirective : env -> Pp.directive -> env ;;
